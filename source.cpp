...
int main()
{
    ...
    try
    {
        ...
        //Вийняток №3 - операційна система не може виділити пам'ять (складно показати)
        //l.push_back(6);
        //l.push_front(21);
           
        //Вийняток №4 - при додаванні списків перевірка що не сталося
        // переповнення лічильника SIZE (складно показати)
        //l = l + l2;
        //l.print();
       
        //Вийняток №5 - помилка доступу до файлу
        //файл List.txt має атрибути тільки для читання
        l.saveInFile();
